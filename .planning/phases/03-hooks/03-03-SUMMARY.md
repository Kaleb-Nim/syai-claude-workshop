...
affects: [03-hooks plan 04 hands-on-build, 03-hooks plan 05 hands-on-fire, 03-hooks plan 06 build verify]
...
# Phase 3 Plan 03: How hooks work — Summary
...
- Authored `pages/03-hooks/03-how-hooks-work.md` exactly per plan spec
...
- `pages/03-hooks/03-how-hooks-work.md` — New section 03 slide (events + minimal JSON + cross-OS dim helpers)
...
- File `pages/03-hooks/03-how-hooks-work.md` — FOUND
