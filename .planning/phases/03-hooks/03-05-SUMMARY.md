...
affects: [03-hooks plan 06 build verify]
...
# Phase 3 Plan 05: Hands-on fire — Summary
...
- Authored `pages/03-hooks/05-hands-on-fire.md` exactly per plan spec
...
- `edf3584` feat(phase-3): section 05 hands-on fire (trigger Stop + Notification, ✓ checks)

## Files

**Created:**
- `pages/03-hooks/05-hands-on-fire.md` (13 lines)

## Self-Check: PASSED

- FOUND: pages/03-hooks/05-hands-on-fire.md
