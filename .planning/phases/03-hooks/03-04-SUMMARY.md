...
affects: [03-hooks plan 05 hands-on-fire, 03-hooks plan 06 build verify]
...
# Phase 3 Plan 04: Hands-on build — Summary
...
- Authored `pages/03-hooks/04-hands-on-build.md` exactly per plan spec
...
- `pages/03-hooks/04-hands-on-build.md` — New section 04 slide (paste-target JSON + reconcile prose + Linux/WSL footnote)
...
- File `pages/03-hooks/04-hands-on-build.md` — FOUND
